      ...
      <div className="octopus-card-bg rounded-2xl p-6 md:p-8">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-3 gap-3 text-sm">
                <div className="bg-blue-900/40 border border-blue-500/30 rounded-xl p-4 text-center">
                  ...
                  <p className="text-gray-300 text-xs mt-1">Cheapest import · Charge battery from grid</p>
                </div>
                <div className="bg-gray-700/40 border border-gray-400/30 rounded-xl p-4 text-center">
                  ...
                  <p className="text-gray-300 text-xs mt-1">Mid rate for import + export</p>
                </div>
                <div className="bg-red-900/40 border border-red-500/30 rounded-xl p-4 text-center">
                  ...
                  <p className="text-gray-300 text-xs mt-1">Highest import AND export rate · Discharge/export battery</p>
                </div>
              </div>
              <p className="text-xs text-gray-300 italic">Times are UK local time (BST/GMT adjusted). The peak window aligns with national evening demand — battery discharge or solar export during this window earns the highest export rate.</p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'knowledge-check' && (
          <div>
            ...
            <p className="text-gray-300 text-sm mb-6">Scenario-based questions to test your Flux knowledge. Questions shuffle each session.</p>
