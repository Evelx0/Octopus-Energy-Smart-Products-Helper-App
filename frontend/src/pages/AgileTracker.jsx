    ...
    <div className="space-y-2">
      ...
      {showPicker && (
        <div className="flex items-center gap-2 pt-1">
          <label className="text-gray-400 text-xs">Choose date:</label>
          <input
            type="date"
        ...
        <div className="octopus-gradient-bg border border-white/10 rounded-xl p-4 text-sm min-w-[220px]">
          ...
          <p className="text-gray-400 text-xs mt-2 italic">
            ...
            {agileProductCode
              ...
              : <span className="font-mono text-gray-400">E-1R-AGILE-…-{selectedRegion}</span>}
          </p>
        </div>
      </div>

      {/* ── SVT context strip ──────────────────────────── */}
      <div className="flex items-center gap-2 mb-4 px-4 py-2 rounded-lg bg-white/5 border border-white/10 text-xs text-gray-400 italic">
        ...
        <span className="text-gray-400">Agile rates below this indicate savings vs the default cap</span>
      </div>
              ...
              {showNowLine && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="octopus-card-bg rounded-xl p-4 text-center">
                    <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Current Import Price</p>
                    <p className="text-3xl font-bold text-white">
                      {dashboard.currentPrice}
                      <span className="text-lg font-normal text-gray-400 ml-1">p/kWh</span>
                    </p>
                  </div>
                  <div className="octopus-card-bg rounded-xl p-4 text-center">
                    <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Cheapest Upcoming Slot</p>
                  ...
                  <div className="octopus-card-bg rounded-xl p-4 text-center">
                    <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Most Expensive Upcoming</p>
                  ...
                  <div className="octopus-card-bg rounded-xl p-4 text-center">
                    <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Region / GSP</p>
