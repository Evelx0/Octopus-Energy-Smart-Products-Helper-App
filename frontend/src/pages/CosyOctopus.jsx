      ...
      <div className="octopus-card-bg rounded-2xl p-6 md:p-8">
          ...
          <div className="space-y-4 text-gray-300 text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-2">
              <div className="bg-teal-900/30 border border-teal-600/30 rounded-xl p-4">
                ...
                <p className="text-gray-400 text-xs mt-1">~51% cheaper than Day rate</p>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                <p className="text-white font-semibold mb-1">Day Rate ⬜</p>
                <p className="text-gray-300 text-xs">All other hours</p>
                <p className="text-gray-400 text-xs mt-1">Standard variable rate</p>
              </div>
              <div className="bg-red-900/30 border border-red-600/30 rounded-xl p-4">
                ...
                <p className="text-gray-400 text-xs mt-1">~50% above Day rate</p>
              </div>
            </div>
            <p className="mt-2">
        ...
        {activeTab === 'tou-bands' && (
          <div className="space-y-6">
            ...
            <div>
              <p className="text-gray-400 text-xs mb-3">24-hour band overview (each block = 1 hour)</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left py-2 pr-4 text-gray-400 font-medium">Band</th>
                    <th className="text-left py-2 pr-4 text-gray-400 font-medium">Hours</th>
                    <th className="text-left py-2 pr-4 text-gray-400 font-medium">vs Day rate</th>
                    <th className="text-left py-2 text-gray-400 font-medium">Best use</th>
                  </tr>
                </thead>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="text-left py-2 pr-4 text-gray-400 font-medium">Rate</th>
                    <th className="text-left py-2 pr-4 text-gray-400 font-medium">Target temp</th>
                    <th className="text-left py-2 text-gray-400 font-medium">Why</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/5 text-gray-300">
                  <tr>
                    <td className="py-3 pr-4 font-mono text-xs text-white">00:00–04:00</td>
                    <td className="py-3 pr-4 text-gray-400 text-xs">Day rate</td>
        ...
        {activeTab === 'knowledge-check' && (
          <div>
            ...
            <p className="text-gray-400 text-sm mb-6">Scenario-based questions to test your Cosy knowledge. Questions shuffle each session.</p>
