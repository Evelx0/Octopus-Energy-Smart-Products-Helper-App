    ...
    <main className="max-w-4xl mx-auto p-6 md:p-8">
      ...
      <header className="my-10">
        ...
        <div className="flex gap-3 mt-4">
          ...
          <Link to="/tariffs/comparison" className="text-sm text-gray-400 hover:text-gray-300 underline">
            → Compare all tariffs
          </Link>
        </div>
      </header>
      ...
      <div className="octopus-card-bg rounded-2xl p-6 md:p-8">
        ...
        {activeTab === 'knowledge-check' && (
          <div>
            ...
            <p className="text-gray-400 text-sm mb-6">Scenario-based questions to test your Tracker knowledge. Questions shuffle each session.</p>
