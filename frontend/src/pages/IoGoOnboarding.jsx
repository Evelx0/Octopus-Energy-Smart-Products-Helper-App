...
function MultiEvTable() {
  return (
    <div className="mt-3 mb-3">
      <p className="text-xs text-gray-400 font-semibold uppercase tracking-wide mb-2">Multi-EV Compatibility Rules</p>
      ...
      <p className="text-xs text-gray-400 mt-1.5">
        Source: <span className="text-gray-400">octopus.energy/blog/intelligent-go-faqs/</span> — to add a second EV, return to the Devices tab after connecting the first and repeat the process.
      </p>
    </div>
  );
}
    ...
    <div className="octopus-card-bg rounded-2xl p-6 md:p-8">
      ...
      <div className="flex items-center justify-between mt-6">
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm font-semibold text-gray-400 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
        >
          ← Previous
        </button>
    ...
    <main className="max-w-4xl mx-auto p-6 md:p-8">
      ...
      <header className="my-10">
        ...
        <div className="flex flex-wrap gap-3 mt-4">
          <Link to="/tariffs/intelligent" className="text-sm text-gray-400 hover:text-gray-300 underline">
            ← IO Go Reference
          </Link>
          <Link to="/tariffs/intelligent-vehicles" className="text-sm text-gray-400 hover:text-gray-300 underline">
            Vehicle Checker
          </Link>
        </div>
      </header>
      ...
      <div className="mt-8 border-t border-white/10 pt-6">
        ...
        <p className="text-gray-400 text-xs mt-1">
          ⚠️ <strong className="text-gray-400">March 2026:</strong> IO Go now includes a 6-hour daily smart charging limit. Charging beyond 6 hours billed at Boost rate. See the IO Go Reference Guide → Smart Charging tab for full details.
        </p>
      </div>
