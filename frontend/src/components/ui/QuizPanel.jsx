  ...
  if (done) {
    return (
      <div ref={topRef} className="text-center py-12 space-y-4">
        ...
        <p className="text-gray-400 text-sm">This is a self-assessment — no score recorded. Come back to test yourself again.</p>
        <button
          onClick={restart}
      ...
      <div className="space-y-3">
        {q.options.map((opt, i) => {
          ...
          if (answered) {
            ...
            else                    style = 'border-white/5 text-gray-400 opacity-50';
          }
          return (
            <button
              key={i}
